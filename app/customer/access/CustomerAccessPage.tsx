...
const copy: Record<SiteLocale, {
  ...
  en: {
    ...
    consent: "I accept the privacy notice and account record retention.",
    wait: "Please wait…",
  ...
  pt: {
    ...
    consent: "Aceito o aviso de privacidade e a retenção dos registros da conta.",
    wait: "Aguarde…",
  ...
  es: {
    ...
    consent: "Acepto el aviso de privacidad y la conservación de los registros de la cuenta.",
    wait: "Espere…",
  ...
  fr: {
    ...
    consent: "J’accepte l’avis de confidentialité et la conservation des données du compte.",
