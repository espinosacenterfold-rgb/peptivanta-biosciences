...
const pageCopy = {
  en: { back: "Back to website", language: "Language", tag: "Service feedback", title: "A clearer view of the buying experience.", text: "Reviewed customer submissions and clearly labelled illustrative examples are displayed together. No medical or efficacy claims are published.", all: "All", countries: ["United States", "Canada", "Brazil", "Mexico"], load: "Load more", empty: "No matching feedback is available.", account: "Customer access" },
  pt: { back: "Voltar ao site", language: "Idioma", tag: "Feedback de serviço", title: "Uma visão mais clara da experiência de compra.", text: "Opiniões revisadas e exemplos ilustrativos identificados aparecem juntos. Não publicamos alegações médicas ou de eficácia.", all: "Todos", countries: ["Estados Unidos", "Canadá", "Brasil", "México"], load: "Carregar mais", empty: "Não há feedback correspondente.", account: "Acesso do cliente" },
  es: { back: "Volver al sitio", language: "Idioma", tag: "Comentarios del servicio", title: "Una visión más clara de la experiencia de compra.", text: "Los comentarios revisados y ejemplos ilustrativos identificados se muestran juntos. No publicamos afirmaciones médicas o de eficacia.", all: "Todos", countries: ["Estados Unidos", "Canadá", "Brasil", "México"], load: "Cargar más", empty: "No hay comentarios coincidentes.", account: "Acceso de clientes" },
  fr: { back: "Retour au site", language: "Langue", tag: "Retours sur le service", title: "Une vision plus claire de l’expérience d’achat.", text: "Les retours vérifiés et exemples illustratifs identifiés sont présentés ensemble. Aucune allégation médicale ou d’efficacité n’est publiée.", all: "Tous", countries: ["États-Unis", "Canada", "Brésil", "Mexique"], load: "Afficher plus", empty: "Aucun retour correspondant.", account: "Accès client" },
  zh: { back: "返回网站", language: "语言", tag: "服务反馈", title: "更清晰地了解采购体验。", text: "经审核的客户提交内容与带标签的示例服务反馈在同一页面展示，不发布医疗或药效类表述。", all: "全部", countries: ["美国", "加拿大", "巴西", "墨西哥"], load: "加载更多", empty: "暂时没有符合条件的反馈。", account: "客户登录" },
} as const;
