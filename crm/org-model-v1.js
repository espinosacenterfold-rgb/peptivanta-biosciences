(() => {
  ...
  function patchHelp(d,role){
    ...
    else if(role==='一级管理员')help.innerHTML='<strong>主管</strong><p>不归属单一销售组，而是管理一个或多个销售组。下方选择其负责的销售组。</p>';
  ...
  function patchForm(d){
    ...
    if(value==='超级管理员'){
      ...
      if(teamTitle)teamTitle.textContent=value==='二级管理员 / 组长'?'所属销售小组 *':'所属销售小组 *';
